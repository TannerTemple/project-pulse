<template>
  <v-container class="pa-6" style="max-width: 800px">
    ...
    <template v-else-if="report">
      <!-- Grade card -->
      <v-card class="mb-4" color="primary" rounded="lg" variant="tonal">
      ...
      <v-alert v-if="report.evaluatorCount === 0" class="mb-4" type="info" variant="tonal">
...
<script lang="ts" setup>
  ...
  import { type ActiveWeek, api, type PeerEvaluationReport } from '@/api'
